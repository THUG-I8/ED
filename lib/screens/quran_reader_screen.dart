...
class _QuranReaderScreenState extends State<QuranReaderScreen>
  ...
  Widget _buildQuranContent(QuranProvider quranProvider) {
    return Column(
      children: [
        _buildPageInfo(quranProvider),
        Expanded(
          child: _buildQuranText(quranProvider),
        ),
        _buildNavigationControls(quranProvider),
      ],
    );
  }

  Widget _buildPageInfo(QuranProvider quranProvider) {
    final currentPageData = quranProvider.currentPageData;
    final currentSurahData = quranProvider.currentSurahData;
  ...
  Widget _buildQuranText(QuranProvider quranProvider) {
  ...
  Widget _buildNavigationControls(QuranProvider quranProvider) {
    return Container(
      padding: EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white,
